...
/**
 * Announce committed App Router route changes to assistive technology.
 *
 * The commit version comes from BrowserRoot's approved visible state, so an
 * aborted or superseded render cannot announce a route the user never saw.
 * The first effect pass only records the initial title or heading because the
 * browser already announces a full document load.
 */
